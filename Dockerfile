...
RUN apt-get update
RUN apt-get update && apt-get install -y php7.3-cli php7.3-mysql php7.3-curl php7.3-gd php7.3-mbstring php7.3-zip php7.3-xml php7.3-sqlite 
RUN apt-get install -y php7.3-soap nodejs libpng-dev git zip unzip
